<?php
/**
 * Configuration file for Admin Inventario Interface
 * Decoupled UI for the Inventario microservice
 */
...
// This allows the app to work from any subdirectory like /admin-inventario/
...
define('API_BASE_URL', $is_local ? 'http://localhost:8003' : 'https://shopnow-inventario.onrender.com');
define('API_TIMEOUT', 10);

// Session Configuration
define('SESSION_NAME', 'admin_inventario_session');
...
function callAPI($endpoint, $method = 'GET', $data = null, $token = null, $queryParams = null) {
    ...
    if ($response === null) {
        ...
        return [
            'success' => false,
            'error' => 'Unable to connect to the Inventario service. Please verify it is running at ' . API_BASE_URL
        ];
    }
    ...
    if ($decoded === null) {
        ...
        return [
            'success' => false,
            'error' => 'Invalid response from Inventario service'
        ];
    }
