# Quick Start Guide - Admin Inventario Interface
...
```bash
cd /home/boomer/ITQ/SOA/ShopNow/admin-inventario
...
- **Admin Inventario:** http://localhost:8080 (this app)
...
### View Inventory
- Dashboard shows all items with their Product IDs and quantities
- Color-coded status: 🟢 Available | 🟡 Low Stock | 🔴 Out of Stock
...
### Can't connect to Inventario service
